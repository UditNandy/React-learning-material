  ...
  return (
    <>
      <Accordian header="How to inject react in a normal HTML page">
        <ul>
          <li>Using CDN links in a normal html file.</li>
          <ul>
            <li>
              As soon as you add these cdn links in your html you will be able
              to use React in you normal html app.
            </li>
            ...
            <li>
              Second file is reacr-dom.development.js which contains logic
            ...
            <li>
              React core file gives the core logic where as the dom file gives
            ...
            <li>
              ...
              operations like managing react hooks, fibers, debugging tools,
              etc. This is not for public use or for building web app as it
              might change over time and can break the application.
            </li>
            <li>
              After injecting react cdn links we can create our react element
              and render it in the html file.
            </li>
            <li>
              To create a element in react we can use{" "}
              <strong>createElement()</strong> method of{" "}
              <strong>React(comes from react core library)</strong> which takes
              3 parameters : tagname, attribute object and (array of
              childElements)/single element/ plain text inside it. This will
              return an object.
            </li>
            <li>
              To render the react element we need to create a reactRoot which
              can be done by invoking <strong>createRoot</strong> method of{" "}
              <strong>ReactDOM (comes from React DOM library)</strong> which
              takes the html element as an argument.
            </li>
            <li>
            ...
            <li>
              The job of root.render() method is to take the react element,
              create the tag in the browser and put the content inside it. This
              render method is responsible for taking the react element and
              convert it to a dom element or the tag.
            </li>
            <li>
              To create nested elements we can simply pass react element/ array
              of react elements as the 3rd paramater in createElement method.
            </li>
            <li>
              Creating a nested structure in react can be really messy this is
              the reason why we need JSX.
            </li>
            <li>
            ...
            <li>
              ...
              case you have to have a seperate div inside body and a seperate
              div for rendering react content.
            </li>
            <li>
              ...
              executes root.render() the content of the root tag will be
              replaced by the react element. You will notice for the 1st few
              miliseconds you will see the initial thing that is written inside
              the root element then it will be replaced by react element.
            </li>
